...
class ShopwareProductionda39a3ee5e6b4b0d3255bfef95601890afd80709ProjectContainer extends Shopware\Components\DependencyInjection\Container
{
    ...
    {
        return $this->services['cache'] = $this->get('cache_factory')->factory('auto', array('automatic_serialization' => true, 'automatic_cleaning_factor' => 0, 'lifetime' => 3600, 'cache_id_prefix' => '902bad3c004a0b8dc24b4ba9ae56f978'), array('hashed_directory_perm' => 511, 'cache_file_perm' => 438, 'hashed_directory_level' => 3, 'cache_dir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/general', 'file_name_prefix' => 'shopware'));
    }
    ...
    {
        return $this->services['db'] = \Shopware\Components\DependencyInjection\Bridge\Db::createEnlightDbAdapter($this->get('dbal_connection'), array('username' => 'dom', 'password' => 'J0nasJenny01', 'dbname' => 'gos', 'host' => 'localhost', 'charset' => 'utf8', 'adapter' => 'pdo_mysql', 'port' => '3306'));
    }
    ...
    {
        return $this->services['dbal_connection'] = \Shopware\Components\DependencyInjection\Bridge\Db::createDbalConnection(array('username' => 'dom', 'password' => 'J0nasJenny01', 'dbname' => 'gos', 'host' => 'localhost', 'charset' => 'utf8', 'adapter' => 'pdo_mysql', 'port' => '3306'), $this->get('modelconfig'), $this->get('model_event_manager'), $this->get('db_connection'));
    }
    ...
    {
        return $this->services['hooks'] = new \Enlight_Hook_HookManager($this->get('events'), $this->get('loader'), array('proxyDir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/proxies', 'proxyNamespace' => 'Shopware_Proxies'));
    }
    ...
    {
        return $this->services['modelannotations'] = $this->get('model_annotations_factory')->factory($this->get('modelconfig'), 'C:\\wamp64\\www\\goshop/engine/Shopware/Models');
    }
    protected function getModelconfigService()
    {
        return $this->services['modelconfig'] = new \Shopware\Components\Model\Configuration(array('autoGenerateProxyClasses' => false, 'attributeDir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/doctrine/attributes', 'proxyDir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/doctrine/proxies', 'proxyNamespace' => 'Shopware\\Proxies', 'cacheProvider' => 'auto', 'cacheNamespace' => NULL), $this->get('cache'), new \Shopware\Components\Model\ProxyAwareRepositoryFactory($this->get('hooks')));
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('C:\\wamp64\\www\\goshop/var/log/core_production.log', 14);
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('C:\\wamp64\\www\\goshop/var/log/plugin_production.log', 14);
        $a->pushProcessor($this->get('monolog.processor.uid'));
    ...
    {
        return $this->services['plugins'] = $this->get('plugins_factory')->factory($this, $this->get('loader'), $this->get('events'), $this->get('application'), array('Default' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Default\\', 'Local' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Local\\', 'Community' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Community\\'));
    }
    ...
    {
        $a = $this->get('session_factory');
        return $this->services['session'] = $a->createSession($this, $a->createSaveHandler($this));
    }
    ...
    {
        return $this->services['shopware.openssl_verificator'] = new \Shopware\Components\OpenSSLVerifier('C:\\wamp64\\www\\goshop/engine/Shopware/Components/HttpClient/public.key');
    }
    ...
    {
        return $this->services['shopware.requirements'] = new \Shopware\Components\Check\Requirements('C:\\wamp64\\www\\goshop/engine/Shopware/Components/Check/Data/System.xml', $this->get('db_connection'));
    }
    ...
    {
        return $this->services['shopware.snippet_database_handler'] = new \Shopware\Components\Snippet\DatabaseHandler($this->get('models'), $this->get('db'), 'C:\\wamp64\\www\\goshop');
    }
    protected function getShopware_SnippetQueryHandlerService()
    {
        return $this->services['shopware.snippet_query_handler'] = new \Shopware\Components\Snippet\QueryHandler('C:\\wamp64\\www\\goshop/snippets/');
    }
    ...
    {
        return $this->services['shopware_account.form.attributeform'] = new \Shopware\Bundle\AccountBundle\Form\Account\AttributeFormType($this->get('models'), $this->get('shopware_attribute.crud_service'));
    }
    ...
    {
        return $this->services['shopware_media.media_service_factory'] = new \Shopware\Bundle\MediaBundle\MediaServiceFactory($this, array(0 => $this->get('shopware_media.adapter.local'), 1 => $this->get('shopware_media.adapter.ftp')), array('backend' => 'local', 'strategy' => 'md5', 'adapters' => array('local' => array('type' => 'local', 'mediaUrl' => '', 'permissions' => array('file' => array('public' => 438, 'private' => 384), 'dir' => array('public' => 511, 'private' => 448)), 'path' => 'C:\\wamp64\\www\\goshop'), 'ftp' => array('type' => 'ftp', 'mediaUrl' => '', 'host' => '', 'username' => '', 'password' => '', 'port' => 21, 'root' => '/', 'passive' => true, 'ssl' => false, 'timeout' => 30))));
    }
    ...
    {
        return $this->services['shopware_media.strategy_factory'] = new \Shopware\Bundle\MediaBundle\Strategy\StrategyFactory(array('backend' => 'local', 'strategy' => 'md5', 'adapters' => array('local' => array('type' => 'local', 'mediaUrl' => '', 'permissions' => array('file' => array('public' => 438, 'private' => 384), 'dir' => array('public' => 511, 'private' => 448)), 'path' => 'C:\\wamp64\\www\\goshop'), 'ftp' => array('type' => 'ftp', 'mediaUrl' => '', 'host' => '', 'username' => '', 'password' => '', 'port' => 21, 'root' => '/', 'passive' => true, 'ssl' => false, 'timeout' => 30))));
    }
    ...
    {
        return $this->services['shopware_plugininstaller.legacy_plugin_installer'] = new \Shopware\Bundle\PluginInstallerBundle\Service\LegacyPluginInstaller($this->get('models'), $this->get('plugins'), array('Default' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Default\\', 'Local' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Local\\', 'Community' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Community\\'));
    }
    protected function getShopwarePlugininstaller_PluginDownloadServiceService()
    {
        return $this->services['shopware_plugininstaller.plugin_download_service'] = new \Shopware\Bundle\PluginInstallerBundle\Service\DownloadService('C:\\wamp64\\www\\goshop', array('Default' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Default\\', 'Local' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Local\\', 'Community' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Community\\'), $this->get('shopware_plugininstaller.store_client'), $this->get('dbal_connection'));
    }
    protected function getShopwarePlugininstaller_PluginInstallerService()
    {
        return $this->services['shopware_plugininstaller.plugin_installer'] = new \Shopware\Bundle\PluginInstallerBundle\Service\PluginInstaller($this->get('models'), $this->get('shopware.snippet_database_handler'), $this->get('shopware.plugin_requirement_validator'), $this->get('db_connection'), 'C:\\wamp64\\www\\goshop');
    }
    ...
    {
        return $this->services['snippets'] = new \Shopware_Components_Snippet_Manager($this->get('models'), array('Default' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Default\\', 'Local' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Local\\', 'Community' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Community\\'), array('readFromDb' => true, 'writeToDb' => true, 'readFromIni' => false, 'writeToIni' => false, 'showSnippetPlaceholder' => false));
    }
    ...
    {
        return $this->services['theme_compiler'] = new \Shopware\Components\Theme\Compiler('C:\\wamp64\\www\\goshop', $this->get('oyejorge_compiler'), $this->get('theme_path_resolver'), $this->get('theme_inheritance'), $this->get('theme_service'), $this->get('js_compressor'), $this->get('events'), $this->get('theme_timestamp_persistor'));
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('C:\\wamp64\\www\\goshop', array('Default' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Default\\', 'Local' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Local\\', 'Community' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Community\\'), $this->get('template'));
    }
    ...
    {
        return $this->services['thumbnail_manager'] = new \Shopware\Components\Thumbnail\Manager($this->get('thumbnail_generator_basic'), 'C:\\wamp64\\www\\goshop', $this->get('events'), $this->get('shopware_media.media_service'));
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:\\wamp64\\www\\goshop',
            'kernel.environment' => 'production',
            'kernel.debug' => false,
            'kernel.name' => 'Shopware',
            'kernel.cache_dir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633',
            'kernel.logs_dir' => 'C:\\wamp64\\www\\goshop/var/log',
            ...
            'shopware.cdn.adapters.local.path' => 'C:\\wamp64\\www\\goshop',
            ...
            'shopware.db.username' => 'dom',
            'shopware.db.password' => 'J0nasJenny01',
            'shopware.db.dbname' => 'gos',
            ...
            'shopware.plugin_directories' => array(
                'Default' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Default\\',
                'Local' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Local\\',
                'Community' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Community\\',
            ),
            'shopware.plugin_directories.default' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Default\\',
            'shopware.plugin_directories.local' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Local\\',
            'shopware.plugin_directories.community' => 'C:\\wamp64\\www\\goshop/engine/Shopware/Plugins\\Community\\',
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/templates',
                'compileDir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/templates',
            ),
            ...
            'shopware.template.cachedir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/templates',
            'shopware.template.compiledir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/templates',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => '902bad3c004a0b8dc24b4ba9ae56f978',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/general',
            ...
            'shopware.cache.frontendoptions.cache_id_prefix' => '902bad3c004a0b8dc24b4ba9ae56f978',
            ...
            'shopware.cache.backendoptions.cache_dir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/general',
            'shopware.cache.backendoptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxydir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/proxies',
            'shopware.hook.proxynamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'attributeDir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/doctrine/attributes',
                'proxyDir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autogenerateproxyclasses' => false,
            'shopware.model.attributedir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/doctrine/attributes',
            'shopware.model.proxydir' => 'C:\\wamp64\\www\\goshop/var/cache/production_201701241633/doctrine/proxies',
