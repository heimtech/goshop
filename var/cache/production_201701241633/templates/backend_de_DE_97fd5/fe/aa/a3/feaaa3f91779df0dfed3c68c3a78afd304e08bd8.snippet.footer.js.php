<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:16
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\index\view\footer.js" */ ?>
<?php /*%%SmartyHeaderCode:881158b848d4b607d9-76543808%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'feaaa3f91779df0dfed3c68c3a78afd304e08bd8' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\index\\view\\footer.js',
      1 => 1485272024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '881158b848d4b607d9-76543808',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848d4c336d9_82363445',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848d4c336d9_82363445')) {function content_58b848d4c336d9_82363445($_smarty_tpl) {?>/**
 * Shopware 5
...
Angemeldet als<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer'/'logged_in_as','default'=>'Logging as','namespace'=>'backend/index/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Jetzt abmelden<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer'/'logout_now','default'=>'Logout now','namespace'=>'backend/index/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Alle minimieren<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer'/'minimize_all','default'=>'Minimize all','namespace'=>'backend/index/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Alle schließen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer'/'close_all','default'=>'Close all','namespace'=>'backend/index/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },
    ...
    getLogoutSnippet: function() {
        var url = '<?php echo '/goshop/backend/login/logout';?>',
            s = this.snippets;
