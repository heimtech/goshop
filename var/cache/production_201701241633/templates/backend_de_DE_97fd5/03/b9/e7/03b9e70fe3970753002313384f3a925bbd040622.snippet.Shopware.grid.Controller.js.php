<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:04
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\base\application\Shopware.grid.Controller.js" */ ?>
<?php /*%%SmartyHeaderCode:1235058b848c8a108d9-60278672%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '03b9e70fe3970753002313384f3a925bbd040622' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\base\\application\\Shopware.grid.Controller.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1235058b848c8a108d9-60278672',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848c8ce3350_06519408',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848c8ce3350_06519408')) {function content_58b848c8ce3350_06519408($_smarty_tpl) {?>
/**
...
Ext.define('Shopware.grid.Controller', {
     ...
     * @type { string }
     */
    deleteConfirmTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"grid_controller/delete_confirm_title",'default'=>'Delete items','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_controller/delete_confirm_title",'default'=>'Delete items','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Einträge löschen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_controller/delete_confirm_title",'default'=>'Delete items','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { string }
     */
    deleteConfirmText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"grid_controller/delete_confirm_text",'default'=>'Are you sure you want to delete the selected items?','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_controller/delete_confirm_text",'default'=>'Are you sure you want to delete the selected items?','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Sind Sie sicher, dass Sie die markierten Einträge löschen möchen?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_controller/delete_confirm_text",'default'=>'Are you sure you want to delete the selected items?','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { string }
     */
    deleteInfoText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"grid_controller/delete_info_text",'default'=>'<b>The records will be deleted.</b> <br>To cancel the process, you can use the <b><i>`Cancel process`</i></b> Button. Depending on the selected volume of data may take several seconds to complete this process.','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_controller/delete_info_text",'default'=>'<b>The records will be deleted.</b> <br>To cancel the process, you can use the <b><i>`Cancel process`</i></b> Button. Depending on the selected volume of data may take several seconds to complete this process.','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<b>Die Einträge werden gelöscht.</b> <br>Um den Prozess abzubrechen, können Sie den <b><i>`Cancel process`</i></b> Button verwenden. Abhängig von der Datenmenge kann dieser Prozess einige Minuten in Anspruch nehmen.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_controller/delete_info_text",'default'=>'<b>The records will be deleted.</b> <br>To cancel the process, you can use the <b><i>`Cancel process`</i></b> Button. Depending on the selected volume of data may take several seconds to complete this process.','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { string }
     */
    deleteProgressBarText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"grid_controller/delete_progress_bar_text",'default'=>'Item [0] of [1]','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_controller/delete_progress_bar_text",'default'=>'Item [0] of [1]','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Eintrag [0] von [1]<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_controller/delete_progress_bar_text",'default'=>'Item [0] of [1]','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
