<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:34:35
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\theme\view\list\theme.js" */ ?>
<?php /*%%SmartyHeaderCode:1204558b8499b273555-30219396%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '02b22f8abb3d2260b4ad3ed254c512a1ee9cb481' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\theme\\view\\list\\theme.js',
      1 => 1485272024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1204558b8499b273555-30219396',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b8499b3ee3d7_59589724',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b8499b3ee3d7_59589724')) {function content_58b8499b3ee3d7_59589724($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?>*/
    ...
    createDropZone: function () {
        ...
        me.dropZone = Ext.create('Shopware.app.FileUpload', {
            requestURL: '<?php echo '/goshop/backend/Theme/upload';?>',
...
Einzelnes Theme per Drag+Drop hochladen (zip)<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'drop_zone','default'=>'Upload single theme using drag+drop (zip)','namespace'=>'backend/theme/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        });
...
Theme erfolgreich hochgeladen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'upload_message','default'=>'Theme uploaded successfully','namespace'=>'backend/theme/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
';
...
Aktiv<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'enabled','default'=>'Enabled','namespace'=>'backend/theme/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</span></div>';
...
Vorschau<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'preview_hint','default'=>'Preview','namespace'=>'backend/theme/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</span></div>';
                        } else {
