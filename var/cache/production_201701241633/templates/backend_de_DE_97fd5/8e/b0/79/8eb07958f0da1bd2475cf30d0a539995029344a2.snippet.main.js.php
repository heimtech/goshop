<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:30
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\article_list\controller\main.js" */ ?>
<?php /*%%SmartyHeaderCode:3144158b848e2793d58-58881942%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8eb07958f0da1bd2475cf30d0a539995029344a2' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\article_list\\controller\\main.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3144158b848e2793d58-58881942',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848e2a108d8_75974194',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848e2a108d8_75974194')) {function content_58b848e2a108d8_75974194($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.ArticleList.controller.Main', {
    ...
    loadDetailModelFields: function () {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/ArticleList/columnConfig';?>',
            params: {
                resource: 'product'
            },
            method: 'GET',
    ...
    createDetailModel: function (data) {
        ...
        Ext.define('Shopware.apps.ArticleList.model.Detail', {
            ...
            proxy: {
                 ...
                 */
                api: {
                    create: '<?php echo '/goshop/backend/ArticleList/saveSingleEntity';?>',
                    update: '<?php echo '/goshop/backend/ArticleList/saveSingleEntity';?>',
                    destroy: '<?php echo '/goshop/backend/ArticleList/deleteProduct';?>'
                },
