<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:08
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\base\component\Shopware.form.field.TinyMCE.js" */ ?>
<?php /*%%SmartyHeaderCode:1671958b848cca667d1-86081242%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '83c905fef6b6c344924d00e9abefa1f1b9a382c0' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\base\\component\\Shopware.form.field.TinyMCE.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1671958b848cca667d1-86081242',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58b848ccc08753_95199338',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848ccc08753_95199338')) {function content_58b848ccc08753_95199338($_smarty_tpl) {?>/**
 * Shopware 5
...
/** @lends Ext.form.field.TextArea# */
{
    ...
    statics: {
        ...
        settings: {
            ...
            media_strict : false,
            relative_urls : true,
            language: "<?php echo $_smarty_tpl->tpl_vars['tinymceLang']->value;?>
",
            mode: "textareas",
            theme: "advanced",
            skin: "o2k7",
            ...
            document_base_url: '<?php ob_start();?><?php echo 'http://localhost/goshop/backend';?><?php $_tmp1=ob_get_clean();?><?php echo dirname($_tmp1);?>
/',

            // Content CSS - Styles the tiny mce editor. Please note the append timestamp. It's used to prevent caching the stylesheet
            contentCSS: 'http://localhost/goshop/themes/Backend/ExtJs/backend/_resources/styles/tiny_mce.css?_dc=' + new Date().getTime(),
     ...
     */
    preloadImageUrl: '<?php echo '/goshop/backend/MediaManager/getMediaUrls';?>',
    ...
    replaceSmartyPluginWithImagePaths: function(rawContent) {
        ...
        Ext.each(images, function(img) {
            ...
            element.setAttribute('src', '/goshop/engine/Library/TinyMce/plugins/media_selection/assets/placeholder-image.png');
        });
