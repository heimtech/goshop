<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:33
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\order\controller\batch.js" */ ?>
<?php /*%%SmartyHeaderCode:1558958b848e55ceb53-57852820%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '00d5a145c76212780bf86124377853fb3603c46f' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\order\\controller\\batch.js',
      1 => 1485272024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1558958b848e55ceb53-57852820',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848e57becd7_24468752',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848e57becd7_24468752')) {function content_58b848e57becd7_24468752($_smarty_tpl) {?>/**
 * Shopware 5
...
Erstelle Dokument [0] von [1] ...<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'progress_bar','default'=>'Create document [0] of [1] ...','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        done: {
...
Alle Dokumente erstellt<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'done_message','default'=>'All documents have been created','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Dokument-Erstellung<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'done_title','default'=>'Document creation','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
        cancel: {
...
Abgebrochen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'cancel_title','default'=>'Cancelled','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
    ...
    queueProcess: function(store, orders, index, resultStore) {
        ...
        if (index === orders.length) {
            ...
            if(settingValues.createSingleDocument) {
                ...
                window.open('<?php echo '/goshop/backend/Order/mergeDocuments';?>?data=' + data, '_blank');
            }
