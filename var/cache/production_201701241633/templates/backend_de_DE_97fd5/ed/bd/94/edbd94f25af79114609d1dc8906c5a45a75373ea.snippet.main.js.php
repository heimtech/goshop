<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:17
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\index\controller\main.js" */ ?>
<?php /*%%SmartyHeaderCode:3183558b848d5e276d6-16025985%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'edbd94f25af79114609d1dc8906c5a45a75373ea' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\index\\controller\\main.js',
      1 => 1485272024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3183558b848d5e276d6-16025985',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58b848d6359cd8_99779186',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848d6359cd8_99779186')) {function content_58b848d6359cd8_99779186($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp6=ob_get_clean();?><?php if ($_tmp6){?>*/
    ...
    checkLoginStatus: function() {
        Ext.TaskManager.start({
            ...
            run: function() {
                Ext.Ajax.request({
                    url: '<?php echo '/goshop/backend/login/getLoginStatus';?>',
                    success: function(response) {
                        var json = Ext.decode(response.responseText);

                        if(!json.success) {
                            window.location.href = '<?php echo '/goshop/backend';?>';
                        }
                    },
                    failure: function() {
                        window.location.href = '<?php echo '/goshop/backend';?>';
