<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:28
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\order\view\detail\communication.js" */ ?>
<?php /*%%SmartyHeaderCode:7358b848e05fd951-85087729%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e2ceeb0f1d24cee66695871ca7dbe27b233364b0' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\order\\view\\detail\\communication.js',
      1 => 1485272024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7358b848e05fd951-85087729',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848e09d5f50_38232158',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848e09d5f50_38232158')) {function content_58b848e09d5f50_38232158($_smarty_tpl) {?>/**
 * Shopware 5
...
Kommunikation<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'communication'/'window_title','default'=>'Communication','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        internal: {
...
Dieses Kommentarfeld dient nur der internen Kommunikation. Das Feld wird zu keiner Zeit im Frontend und für den Kunden sichtbar ausgegeben.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'communication'/'internal'/'text','default'=>'This comment box is for internal communication. The field is not visible in the frontend and for the customer at any given time.','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Internen Kommentar speichern<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'communication'/'internal'/'button','default'=>'Save internal comment','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
        external: {
...
Die beiden nachfolgenden Kommentarfelder sind im Kundenkonto für den Kunden sichtbar. Nach dem Speichern der externen Kommentare ist Ihr Kommentar unmittelbar sichtbar.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'communication'/'external'/'text','default'=>'This comment box is for internal communication. The field is not visible in the frontend and for the customer at any given time.','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
