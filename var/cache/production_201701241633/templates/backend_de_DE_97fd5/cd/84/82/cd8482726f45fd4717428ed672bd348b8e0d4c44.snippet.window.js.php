<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:16
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\index\view\widgets\window.js" */ ?>
<?php /*%%SmartyHeaderCode:470558b848d4cf2d59-10856006%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cd8482726f45fd4717428ed672bd348b8e0d4c44' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\index\\view\\widgets\\window.js',
      1 => 1485272024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '470558b848d4cf2d59-10856006',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848d4f310d8_44630411',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848d4f310d8_44630411')) {function content_58b848d4f310d8_44630411($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.Index.view.widgets.Window', {
    ...
    snippets: {
        toolbar: {
            title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"window/toolbar/headline",'default'=>'Widgets','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/headline",'default'=>'Widgets','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Widgets<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/headline",'default'=>'Widgets','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            minimize: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"window/toolbar/minimize",'default'=>'Minimize window','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/minimize",'default'=>'Minimize window','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Fenster minimieren<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/minimize",'default'=>'Minimize window','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            dock: {
                topLeft: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"window/toolbar/dock/topLeft",'default'=>'Top left','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/dock/topLeft",'default'=>'Top left','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Oben links<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/dock/topLeft",'default'=>'Top left','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                topRight: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"window/toolbar/dock/topRight",'default'=>'Top right','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/dock/topRight",'default'=>'Top right','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Oben rechts<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/dock/topRight",'default'=>'Top right','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                bottomLeft: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"window/toolbar/dock/bottomLeft",'default'=>'Bottom left','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/dock/bottomLeft",'default'=>'Bottom left','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Unten links<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/dock/bottomLeft",'default'=>'Bottom left','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                bottomRight: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"window/toolbar/dock/bottomRight",'default'=>'Bottom right','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/dock/bottomRight",'default'=>'Bottom right','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Unten rechts<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"window/toolbar/dock/bottomRight",'default'=>'Bottom right','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
            }
        }
    },
