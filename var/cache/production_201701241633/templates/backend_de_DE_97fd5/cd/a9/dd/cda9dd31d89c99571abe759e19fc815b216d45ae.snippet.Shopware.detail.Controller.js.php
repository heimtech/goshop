<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:06
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\base\application\Shopware.detail.Controller.js" */ ?>
<?php /*%%SmartyHeaderCode:1546958b848ca165cd7-27195059%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cda9dd31d89c99571abe759e19fc815b216d45ae' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\base\\application\\Shopware.detail.Controller.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1546958b848ca165cd7-27195059',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848ca2fff59_58208119',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848ca2fff59_58208119')) {function content_58b848ca2fff59_58208119($_smarty_tpl) {?>
//
//
Ext.define('Shopware.detail.Controller', {
     ...
     * @type { String }
     */
    saveSuccessTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"detail_controller/save_success_title",'default'=>'Success','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_controller/save_success_title",'default'=>'Success','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Erfolgreich<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_controller/save_success_title",'default'=>'Success','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    saveSuccessMessage: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"detail_controller/save_success_message",'default'=>'Item saved successfully','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_controller/save_success_message",'default'=>'Item saved successfully','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Eintrag wurde erfolgreich gespeichert<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_controller/save_success_message",'default'=>'Item saved successfully','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    violationErrorTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"detail_controller/violation_error_title",'default'=>'Violation errors','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_controller/violation_error_title",'default'=>'Violation errors','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Validierung Fehler<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_controller/violation_error_title",'default'=>'Violation errors','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    invalidFormTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"detail_controller/invalid_form_title",'default'=>'Form validation error','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_controller/invalid_form_title",'default'=>'Form validation error','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Formularvalidierungs Fehler<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_controller/invalid_form_title",'default'=>'Form validation error','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    invalidFormMessage: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"detail_controller/invalid_form_message",'default'=>'The form contains invalid data, please check the inserted values.','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_controller/invalid_form_message",'default'=>'The form contains invalid data, please check the inserted values.','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Das Formular beinhaltet invalidate Daten, bitte prüfen Sie ihre Eingabe.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_controller/invalid_form_message",'default'=>'The form contains invalid data, please check the inserted values.','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
