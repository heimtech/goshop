<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:17
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\index\view\widgets\merchant.js" */ ?>
<?php /*%%SmartyHeaderCode:2966758b848d5699d52-49022803%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '085003d626cb4b1edf302793547c5b81f79a24db' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\index\\view\\widgets\\merchant.js',
      1 => 1485272024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2966758b848d5699d52-49022803',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848d585b0d3_20186726',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848d585b0d3_20186726')) {function content_58b848d585b0d3_20186726($_smarty_tpl) {?>/**
 * Shopware 5
...
Letzte Bestellungen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'orders'/'title','default'=>'Last orders','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
    layout: 'fit',
...
Datum<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'merchant'/'headers'/'date','default'=>'Date','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Firma<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'merchant'/'headers'/'name','default'=>'Company name','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Kunde<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'merchant'/'headers'/'customer','default'=>'Customer','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Ausgewählter Händler konnte nicht erfolgreich freigeschaltet werden.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'merchant'/'failure_msg'/'text','default'=>'Selected merchant couldn\'t be unlocked successfully.','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
"
        },
        tooltips: {
...
'
    ...
    constructor: function() {
        ...
        me.merchantStore = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                url: '<?php echo '/goshop/backend/widgets/getLastMerchant';?>',
                reader: {
                    type: 'json',
                    root: 'data'
                }
