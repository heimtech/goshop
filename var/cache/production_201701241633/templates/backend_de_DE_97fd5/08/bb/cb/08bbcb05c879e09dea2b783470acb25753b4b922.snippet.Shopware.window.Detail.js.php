<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:05
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\base\application\Shopware.window.Detail.js" */ ?>
<?php /*%%SmartyHeaderCode:468258b848c94b5758-88338971%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '08bbcb05c879e09dea2b783470acb25753b4b922' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\base\\application\\Shopware.window.Detail.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '468258b848c94b5758-88338971',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848c9712ed2_24473515',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848c9712ed2_24473515')) {function content_58b848c9712ed2_24473515($_smarty_tpl) {?>
//
//
...
Ext.define('Shopware.window.Detail', {
     ...
     * @type { String }
     */
    cancelButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"detail_window/cancel_button_text",'default'=>'Cancel','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_window/cancel_button_text",'default'=>'Cancel','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Abbrechen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_window/cancel_button_text",'default'=>'Cancel','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    saveButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"detail_window/save_button_text",'default'=>'Save','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_window/save_button_text",'default'=>'Save','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Speichern<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"detail_window/save_button_text",'default'=>'Save','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
