<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:13
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\base\attribute\Shopware.attribute.Form.js" */ ?>
<?php /*%%SmartyHeaderCode:2625058b848d10a27d2-88493075%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4c637147e4afc36932bbac028bf620fe619a15b6' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\base\\attribute\\Shopware.attribute.Form.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2625058b848d10a27d2-88493075',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848d122d057_56358619',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848d122d057_56358619')) {function content_58b848d122d057_56358619($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.attribute.Form', {
    ...
    loadAttribute: function(foreignKey, callback) {
        ...
        me.load({
            url: '<?php echo '/goshop/backend/AttributeData/loadData';?>',
            params: {
    ...
    saveAttribute: function(foreignKey, callback) {
        ...
        me.submit({
            url: '<?php echo '/goshop/backend/AttributeData/saveData';?>',
            params: {
                _table: me.table,
                _foreignKey: foreignKey
            },
...
Freitextfelder<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"attribute_form_title",'namespace'=>'backend/attributes/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            defaults: { anchor: '100%' },
            layout: 'anchor',
            background: 'transparent',
...
Jetzt konfigurieren<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"configure_now",'namespace'=>'backend/attributes/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Aktualisieren<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"reload",'namespace'=>'backend/attributes/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Für dieses Module wurden noch keine Freitextfelder konfiguriert<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"notification",'namespace'=>'backend/attributes/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        });
