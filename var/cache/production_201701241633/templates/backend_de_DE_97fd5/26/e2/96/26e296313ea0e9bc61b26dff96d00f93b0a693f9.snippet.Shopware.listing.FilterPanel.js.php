<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:06
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\base\application\Shopware.listing.FilterPanel.js" */ ?>
<?php /*%%SmartyHeaderCode:2897958b848ca4a5d58-62144295%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '26e296313ea0e9bc61b26dff96d00f93b0a693f9' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\base\\application\\Shopware.listing.FilterPanel.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2897958b848ca4a5d58-62144295',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848ca69dbd7_69495829',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848ca69dbd7_69495829')) {function content_58b848ca69dbd7_69495829($_smarty_tpl) {?>
...
Ext.define('Shopware.listing.FilterPanel', {
     ...
     * #@type { String }
     */
    title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"filter_panel/title",'default'=>'Filters','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/title",'default'=>'Filters','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Filter<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/title",'default'=>'Filters','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    infoTextSnippet: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"filter_panel/info_text",'default'=>'Activate the filter fields over the checkbox which displayed for each field. Activated fields will be joined with an AND condition.','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/info_text",'default'=>'Activate the filter fields over the checkbox which displayed for each field. Activated fields will be joined with an AND condition.','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Aktivieren Sie der verschiedenen Felder über die davor angezeigte Checkbox. Aktivierte Felder werden mit einer UND Bedingung verknüpft.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/info_text",'default'=>'Activate the filter fields over the checkbox which displayed for each field. Activated fields will be joined with an AND condition.','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    filterButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"filter_panel/filter_button_text",'default'=>'Filter result','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/filter_button_text",'default'=>'Filter result','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Filter anwenden<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/filter_button_text",'default'=>'Filter result','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    resetButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"filter_panel/reset_button_text",'default'=>'Reset filters','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/reset_button_text",'default'=>'Reset filters','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Filter zurücksetzen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/reset_button_text",'default'=>'Reset filters','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
    ...
    statics: {
        ...
        displayConfig: {
             ...
             * @type { String }
             */
            searchUrl: '<?php echo '/goshop/backend/base/searchAssociation';?>',
