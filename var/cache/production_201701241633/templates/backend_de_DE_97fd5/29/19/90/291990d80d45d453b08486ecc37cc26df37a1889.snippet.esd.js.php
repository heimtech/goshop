<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:38
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\article\controller\esd.js" */ ?>
<?php /*%%SmartyHeaderCode:2868958b848ea303dd9-67420295%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '291990d80d45d453b08486ecc37cc26df37a1889' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\article\\controller\\esd.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2868958b848ea303dd9-67420295',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848ea65f3d0_97284627',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848ea65f3d0_97284627')) {function content_58b848ea65f3d0_97284627($_smarty_tpl) {?>/**
 * Shopware 5
...
Seriennummern hinzufügen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'add_serials_title','default'=>'Add Serials','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        error: {
...
Fehler<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'error'/'title','default'=>'Error','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Der ESD Ordner konnte nicht gefunden werden.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'error'/'no_folder','default'=>'The ESD folder could not be found.','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
        success: {
...
Erfolgreich<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'success'/'title','default'=>'Success','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Die markierten ESD-Artikel wurden gelöscht<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'success'/'esd_removed','default'=>'The selected ESDs have been removed','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Nicht vergebene Seriennummern wurden gelöscht<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'success'/'unused_serials_removed','default'=>'All unused serialnumbers have been removed','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Die markierten Seriennummern wurden gelöscht<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'success'/'serial_removed','default'=>'The selected serialnumbers have been removed','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
        messages: {
...
Neue Seriennummer hinzufügen (Mit Zeilenumbruch separieren)<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'message'/'add_serials','default'=>'Add new Serials (separated by newlines)','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
        buttons: {
...
Seriennummer hinzufügen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'buttons'/'add_serials','default'=>'Add serials','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Abbrechen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'message'/'cancel','default'=>'Cancel','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        }
    },
    ...
    onAddEsd: function(articleDetailId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/Article/createEsd';?>',
            method: 'POST',
            params: {
    ...
    saveNewSerials: function(serials) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/Article/saveSerials';?>',
            method: 'POST',
            params: {
    ...
    onDeleteUnusedSerials: function() {
        ...
        Ext.MessageBox.confirm(me.snippets.growlMessage, me.snippets.messages.serialsRemoveUnused , function (response) {
            ...
            Ext.Ajax.request({
                url: '<?php echo '/goshop/backend/Article/deleteUnusedSerials';?>',
                method: 'POST',
                params: {
                    esdId: me.detailWindow.esdRecord.get('id')
                },
    ...
    onDownloadFile: function() {
        ...
        var url = '<?php echo '/goshop/backend/Article/getEsdDownload';?>' + '/filename/' + record.get('file');
