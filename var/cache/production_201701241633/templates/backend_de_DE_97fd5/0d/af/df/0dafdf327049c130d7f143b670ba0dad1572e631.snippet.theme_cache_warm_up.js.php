<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:17
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\index\view\theme_cache\theme_cache_warm_up.js" */ ?>
<?php /*%%SmartyHeaderCode:2745558b848d5b9efd5-91187878%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0dafdf327049c130d7f143b670ba0dad1572e631' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\index\\view\\theme_cache\\theme_cache_warm_up.js',
      1 => 1485272024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2745558b848d5b9efd5-91187878',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848d5cfe8d9_91191260',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848d5cfe8d9_91191260')) {function content_58b848d5cfe8d9_91191260($_smarty_tpl) {?>/**
 * Shopware 5
...
Abbrechen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'button'/'cancel','default'=>'Cancel process','namespace'=>'backend/index/view/theme_cache'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Themes kompilieren<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'button'/'start','default'=>'Start process','namespace'=>'backend/index/view/theme_cache'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Schließen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'button'/'close','default'=>'Close window','namespace'=>'backend/index/view/theme_cache'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
0 Theme Shop(s) gefunden<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'progress'/'progress_bar_text','default'=>'0 shop(s) found','namespace'=>'backend/index/view/theme_cache'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Kompiliere Theme für Shop "[0]"<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'progress'/'progress_bar_single_text','default'=>'Warm up cache for [0]','namespace'=>'backend/index/view/theme_cache'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Lade...<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'progress'/'progress_bar_loading','default'=>'Loading...','namespace'=>'backend/index/view/theme_cache'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Die Theme Dateien müssen kompiliert werden. Dies ist nur nötig, wenn Sie grundlegende Änderungen am Theme vorgenommen haben. Falls die Themes nicht manuell kompiliert werden, werden Änderungen an Themes nicht im Frontend übernommen. Sollten keine kompilierten Dateien beim Aufruf des Frontends vorliegen, wird der Prozess automatisch angestoßen.<br><br>Bei Auswahl eines oder mehrerer Shops werden nur diese kompiliert. Ansonsten alle.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'fieldset'/'information'/'detail','default'=>'This will warm up the cache for your shop themes. This process will take a few seconds per shop','namespace'=>'backend/index/view/theme_cache'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },
    ...
    createShopSelector: function() {
        ...
        return Ext.create('Ext.form.field.ComboBox', {
            ...
            multiSelect: true,
            editable: false,
            emptyText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'fieldset'/'information'/'shopselection','default'=>'Shop selection','namespace'=>'backend/index/view/theme_cache')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'fieldset'/'information'/'shopselection','default'=>'Shop selection','namespace'=>'backend/index/view/theme_cache'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Shopauswahl<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'fieldset'/'information'/'shopselection','default'=>'Shop selection','namespace'=>'backend/index/view/theme_cache'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            listeners: {
                scope: me,
