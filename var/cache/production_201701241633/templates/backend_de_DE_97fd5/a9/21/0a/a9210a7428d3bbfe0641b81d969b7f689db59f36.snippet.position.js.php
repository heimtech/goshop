<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:28
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\order\view\detail\position.js" */ ?>
<?php /*%%SmartyHeaderCode:340658b848e0a43558-65242869%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a9210a7428d3bbfe0641b81d969b7f689db59f36' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\order\\view\\detail\\position.js',
      1 => 1485272024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '340658b848e0a43558-65242869',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848e0d6fd51_80292380',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848e0d6fd51_80292380')) {function content_58b848e0d6fd51_80292380($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.Order.view.detail.Position', {
     ...
     */
    snippets:{
        title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'position'/'window_title','default'=>'Positions','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'position'/'window_title','default'=>'Positions','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Positionen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'position'/'window_title','default'=>'Positions','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        add:'<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'position'/'button_add','default'=>'Add','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'position'/'button_add','default'=>'Add','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Hinzufügen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'position'/'button_add','default'=>'Add','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        remove:'<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'position'/'button_delete','default'=>'Delete all selected','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'position'/'button_delete','default'=>'Delete all selected','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Alle markierten löschen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'position'/'button_delete','default'=>'Delete all selected','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },
