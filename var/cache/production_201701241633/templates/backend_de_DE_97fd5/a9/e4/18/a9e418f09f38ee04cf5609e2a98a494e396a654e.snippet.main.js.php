<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:36
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\article\controller\main.js" */ ?>
<?php /*%%SmartyHeaderCode:2649558b848e8ccbc52-97268501%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a9e418f09f38ee04cf5609e2a98a494e396a654e' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\article\\controller\\main.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2649558b848e8ccbc52-97268501',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848e8e0ffd4_44417643',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848e8e0ffd4_44417643')) {function content_58b848e8e0ffd4_44417643($_smarty_tpl) {?>/**
 * Shopware 5
...
'
        ...
        generateNeeded: {
            title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'detail'/'needGenerate'/'title','default'=>'Duplicate article','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'detail'/'needGenerate'/'title','default'=>'Duplicate article','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Artikel duplizieren<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'detail'/'needGenerate'/'title','default'=>'Duplicate article','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            message: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'detail'/'needGenerate'/'message','default'=>'You have just duplicated a configurator article. The corresponding configurator variants were not duplicated for performance and stability reasons. \' +
                     \'Please go to the tab \\\'Variants\\\' and then click \\\'Generate variants\\\' to duplicate the configurator variants, too.','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'detail'/'needGenerate'/'message','default'=>'You have just duplicated a configurator article. The corresponding configurator variants were not duplicated for performance and stability reasons. \' +
                     \'Please go to the tab \\\'Variants\\\' and then click \\\'Generate variants\\\' to duplicate the configurator variants, too.','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Sie haben soeben einen Konfigurator-Artikel dupliziert. Die dazugehörigen Konfigurator-Varianten wurden aus Performance- und Stabilitäts-Gründen nicht dupliziert. Bitte wechseln Sie auf den Reiter \'Varianten\' und anschließend auf \'Varianten generieren\', um die Konfigurator-Varianten ebenfalls zu duplizieren.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'detail'/'needGenerate'/'message','default'=>'You have just duplicated a configurator article. The corresponding configurator variants were not duplicated for performance and stability reasons. \' +
                     \'Please go to the tab \\\'Variants\\\' and then click \\\'Generate variants\\\' to duplicate the configurator variants, too.','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        }
    },
