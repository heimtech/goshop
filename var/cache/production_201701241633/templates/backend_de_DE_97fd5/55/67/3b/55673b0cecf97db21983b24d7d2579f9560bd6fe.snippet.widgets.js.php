<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:18
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\index\controller\widgets.js" */ ?>
<?php /*%%SmartyHeaderCode:2380058b848d63a7ed6-13871274%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '55673b0cecf97db21983b24d7d2579f9560bd6fe' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\index\\controller\\widgets.js',
      1 => 1485272024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2380058b848d63a7ed6-13871274',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848d6588653_33981561',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848d6588653_33981561')) {function content_58b848d6588653_33981561($_smarty_tpl) {?>/**
 * Shopware 5
...
Ein Fehler ist bei dem löschen des Widgets aufgetreten.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"error/deleteWidget",'default'=>'An Error occurred while attempting to delete the widget.\\n\\n','namespace'=>'backend/index/controller/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?>*/
    ...
    onSaveWidgetPosition: function (column, row, internalId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/widgets/savePosition';?>',
            params: {
                column: column,
                position: row,
                id: internalId
    ...
    onSaveWidgetPositions: function (widgets) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/widgets/savePositions';?>',
            jsonData: {
                widgets: widgets
            },
    ...
    onAddWidget: function (win, widgetName, menuItem) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/widgets/addWidgetView';?>',
            jsonData: {
                id: widget.get('id'),
                column: 0,
    ...
    onCloseWidget: function (widget) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/widgets/removeWidgetView';?>',
            params: {
                id: widget.viewId
            },
            callback: function (options, success, res) {
    ...
    onOpenMerchantDetail: function (mode, record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/widgets/requestMerchantForm';?>',
            params: {
                id: ~~(1 * record.get('id')),
