<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:34
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\article\view\variant\configurator\dependency.js" */ ?>
<?php /*%%SmartyHeaderCode:2047358b848e6181252-69902042%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3d16e3282f6fef1596f29d9cc7ea7158a77b95f7' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\article\\view\\variant\\configurator\\dependency.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2047358b848e6181252-69902042',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848e62f0551_70523067',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848e62f0551_70523067')) {function content_58b848e62f0551_70523067($_smarty_tpl) {?>/**
 * Shopware 5
...
In diesem Bereich haben Sie die Möglichkeit, Einschränkungen für die Generierung von Artikel Varianten zu setzen. So können Sie Kombinationen definieren, die bei der Erstellung der Varianten ausgeschlossen werden. Einschränkungen werden als Regelset angelegt, was Ihnen den Vorteil bietet, dass Sie mehrere Kombinationen aus Attribut-Gruppen und Optionen ausschließen können. Um eine Einschränkung zu definieren, wählen Sie bitte in den unten aufgeführten Auswahlboxen die Attribut-Gruppe und die Option aus, die Sie für die Generierung ausschließen möchten.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'variant'/'configurator'/'dependency'/'notice','default'=>'In this area you have the opportunity to declare restrictions for the generation of product variants. You can define combinations which are supposed to be excluded from the creation of the product variants. Restrictions are applied as a kind rule set, which offers the advantage to define restrictions based on several combinations of attribute groups and options. To define a restriction, please select the attribute group and option which is supposed to be excluded from the generation from the attached selection boxes below.','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Gruppe<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'variant'/'configurator'/'dependency'/'group','default'=>'Group','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Speichern<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'variant'/'configurator'/'dependency'/'save','default'=>'Save','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
