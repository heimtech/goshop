<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:06
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\base\application\Shopware.form.field.Media.js" */ ?>
<?php /*%%SmartyHeaderCode:945458b848ca84b6d6-59238481%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '89bd794000959ae84630456fe1c15ccb1b3ee2db' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\base\\application\\Shopware.form.field.Media.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '945458b848ca84b6d6-59238481',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848caa08bd8_92567858',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848caa08bd8_92567858')) {function content_58b848caa08bd8_92567858($_smarty_tpl) {?>//
//
Ext.define('Shopware.form.field.Media', {
     ...
     * @type { String }
     */
    noMedia: '/goshop/themes/Backend/ExtJs/backend/_resources/images/index/no-picture.jpg',
     ...
     * @type { String }
     */
    selectButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"media_field/select_button_text",'default'=>'Select media','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"media_field/select_button_text",'default'=>'Select media','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Medium selektieren<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"media_field/select_button_text",'default'=>'Select media','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    resetButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"media_field/reset_button_text",'default'=>'Reset media','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"media_field/reset_button_text",'default'=>'Reset media','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Medium zurücksetzen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"media_field/reset_button_text",'default'=>'Reset media','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
    ...
    requestMediaData: function(value) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/mediaManager/getMedia';?>',
            method: 'POST',
            params: params,
