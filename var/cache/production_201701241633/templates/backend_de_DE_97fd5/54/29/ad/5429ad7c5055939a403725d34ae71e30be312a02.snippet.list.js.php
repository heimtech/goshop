<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:34:36
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\theme\controller\list.js" */ ?>
<?php /*%%SmartyHeaderCode:2232558b8499c136ed8-25284936%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5429ad7c5055939a403725d34ae71e30be312a02' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\theme\\controller\\list.js',
      1 => 1485272024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2232558b8499c136ed8-25284936',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b8499c30bad1_51919026',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b8499c30bad1_51919026')) {function content_58b8499c30bad1_51919026($_smarty_tpl) {?>/**
 * Shopware 5
...
');
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/theme/assign';?>',
            method: 'POST',
            params: {
                shopId: shop.get('id'),
...
',
    ...
    onPreviewTheme: function () {
        var me = this, shop, theme,
            url = '<?php echo '/goshop/backend/theme/preview';?>';
...
');
            ...
            Ext.Ajax.request({
                url: '<?php echo '/goshop/backend/theme/resetPreviewSession';?>',
                method: 'POST',
                params: {
                    shopId: shop.get('id')
                }
...
Vorschau stoppen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'stop_preview','default'=>'Stop preview','namespace'=>'backend/theme/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
