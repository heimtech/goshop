<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:34
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\article\view\variant\configurator\mapping.js" */ ?>
<?php /*%%SmartyHeaderCode:2936558b848e6712ed8-77253194%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '915a542848b576dbde41a2d4745f8dc3a996231a' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\article\\view\\variant\\configurator\\mapping.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2936558b848e6712ed8-77253194',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848e68b4e50_98541609',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848e68b4e50_98541609')) {function content_58b848e68b4e50_98541609($_smarty_tpl) {?>/**
 * Shopware 5
...
In diesem Bereich können Sie Artikelinformationen auswählen und sie zu den selektierten Varianten-Artikel zuordnen. Falls keine Artikelvariante ausgewählt wurde, wird die selektierte Artikelinformation zu allen Varianten-Artikeln zugeordnet.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'variant'/'configurator'/'mapping'/'notice','default'=>'In this area you have the option to transfer selectable article information to the selected variant articles. If there is no selected variant article, the selected article information will be applied to all variant articles.','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Attribut-Konfiguration übernehmen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'variant'/'configurator'/'mapping'/'attribute','default'=>'Apply attribute configuration','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Basispreis-Konfiguration übernehmen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'variant'/'configurator'/'mapping'/'basePrice','default'=>'Apply base price configuration','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Speichern<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'variant'/'configurator'/'mapping'/'save','default'=>'Save','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Abbrechen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'variant'/'configurator'/'mapping'/'cancel','default'=>'Cancel','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },
