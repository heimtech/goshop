<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:32
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\article_list\controller\backup.js" */ ?>
<?php /*%%SmartyHeaderCode:1306558b848e4087250-89622879%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ecdd54136ba1cba3e26b0bccfde4c68c6f25828c' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\article_list\\controller\\backup.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1306558b848e4087250-89622879',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848e445b9d8_82922855',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848e445b9d8_82922855')) {function content_58b848e445b9d8_82922855($_smarty_tpl) {?>/**
 * Shopware 5
...
Soll die gewählte Sicherung gelöscht werden?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'backup'/'deleteConfirm','default'=>'Delete the selected backup?','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Das gewählte Backup mit folgendem Zeitstempel wird gelöscht: [0]. Möchten Sie fortfahren?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'backup'/'deleteConfirmMessage','default'=>'You are about to delete the selected backup from [0]. Do you want to proceed?','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
', record.get('date')),
            function (response) {
                if ( response !== 'yes' ) {
                    return;
...
[0] erfolgreich gelöscht<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'successDeleteMessage','default'=>'Successfully deleted [0]','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
', ''));
                    },
                    failure: function() {
                        store.reload();
...
Fehler<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'errorTitle','default'=>'Error','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
Konnte das Sicherungs-Verzeichnis nicht löschen - stellen Sie sicher, dass es leer ist.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'errorDeleteMessage','default'=>'Could not delete the backup folder - make sure, it is empty','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
                    }
                });
...
Sie werden die gewählten Änderungen rückgängig machen. Fortfahren?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'backup'/'addConfirm'/'Message','default'=>'You are about to revert the selected changes. Do you want to proceed?','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            function (response) {
                if ( response !== 'yes' ) {
                    return;
...
Einspielen der Sicherung<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'restoringTitle','default'=>'Restoring the backup','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Die gewählten Änderungen werden nun rückgängig gemacht.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'restoringMessage','default'=>'Currently restoring the selected backup.','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
",
            width        : 500,
            progress     : true,
            closable     : false,
...
Bereite die Wiederherstellung vor…<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'startingRevert','default'=>'Begin restoring the selected file…','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
    },
    ...
    runRestore: function(config, offset) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/ArticleList/restore';?>',
            timeout: 4000000,
            params : {
                resource: 'product',
                id: config.id,
...
[0] von [1] Delta(s) verarbeitet<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'backup'/'alreadyRestored','default'=>'[0] out of [1] deltas restored','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
Wiederherstellung abgeschlossen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'restoredBackup','default'=>'Backup restored','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Die folgenden Änderungen wurden rückgängig gemacht:<br>[0]<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'createdRestoreMessage','default'=>'The following changes have been undone:<br>[0]','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
