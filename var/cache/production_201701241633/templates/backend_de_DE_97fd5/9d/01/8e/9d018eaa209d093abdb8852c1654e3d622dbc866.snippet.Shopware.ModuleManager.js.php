<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:10
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\base\component\Shopware.ModuleManager.js" */ ?>
<?php /*%%SmartyHeaderCode:1657958b848cedaa6d8-77860110%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9d018eaa209d093abdb8852c1654e3d622dbc866' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\base\\component\\Shopware.ModuleManager.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1657958b848cedaa6d8-77860110',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848ceecb7d7_93284456',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848ceecb7d7_93284456')) {function content_58b848ceecb7d7_93284456($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.ModuleManager', {
    ...
    createContentFrame: function(name, instance, fullPath) {
        ...
        frame = Ext.get(Ext.DomHelper.createDom({
            ...
            'height': '100%',
            'border': '0',
            'src': (fullPath ? name : '<?php echo htmlspecialchars(Shopware()->Front()->Router()->assemble(array('module' => "backend", 'controller' => '', 'forceSecure' => '1', ))); ?>' + name),
...
window.createSimpleModule = Shopware.ModuleManager.createSimplifiedModule.bind(Shopware.ModuleManager);<?php }} ?>