<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:05
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\base\application\Shopware.window.Progress.js" */ ?>
<?php /*%%SmartyHeaderCode:687258b848c98b8cd9-13323271%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '96bec2ce6c8d0d84326486d450603c4b8bf51cca' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\base\\application\\Shopware.window.Progress.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '687258b848c98b8cd9-13323271',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848c9b58ad9_51358761',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848c9b58ad9_51358761')) {function content_58b848c9b58ad9_51358761($_smarty_tpl) {?>
...
Ext.define('Shopware.window.Progress', {
    ...
    title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"progress_window/title",'default'=>'Delete items','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/title",'default'=>'Delete items','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Einträge löschen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/title",'default'=>'Delete items','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    cancelButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"progress_window/cancel_button_text",'default'=>'Cancel process','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/cancel_button_text",'default'=>'Cancel process','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Prozess abbrechen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/cancel_button_text",'default'=>'Cancel process','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    closeButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"progress_window/close_button_text",'default'=>'Close window','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/close_button_text",'default'=>'Close window','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Fenster schließen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/close_button_text",'default'=>'Close window','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    successHeader: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"progress_window/success_header",'default'=>'Success','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/success_header",'default'=>'Success','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Erfolgreich<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/success_header",'default'=>'Success','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    requestHeader: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"progress_window/request_header",'default'=>'Request','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/request_header",'default'=>'Request','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Request<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/request_header",'default'=>'Request','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    errorHeader: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"progress_window/error_header",'default'=>'Error message','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/error_header",'default'=>'Error message','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Fehlermeldung<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/error_header",'default'=>'Error message','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    requestResultTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"progress_window/request_result_title",'default'=>'Request results','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/request_result_title",'default'=>'Request results','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Request Ergebnis<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/request_result_title",'default'=>'Request results','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    processCanceledText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"progress_window/process_canceled_text",'default'=>'Process canceled at position [0] of [1]','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/process_canceled_text",'default'=>'Process canceled at position [0] of [1]','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Prozess wurde an Position [0] von [1] unterbrochen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"progress_window/process_canceled_text",'default'=>'Process canceled at position [0] of [1]','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
