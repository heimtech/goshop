<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:31
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\article_list\controller\batch_process.js" */ ?>
<?php /*%%SmartyHeaderCode:308858b848e3a7ded2-73558912%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b6d83656ac8133ffea26bfefb9570d6a33520c03' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\article_list\\controller\\batch_process.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '308858b848e3a7ded2-73558912',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848e40351d0_31222639',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848e40351d0_31222639')) {function content_58b848e40351d0_31222639($_smarty_tpl) {?>/**
 * Shopware 5
...
Sie werden [0] Produkte zum Queue hinzufügen. Möchten Sie diese Produkte wirklich für die Stapelverarbeitung mit den definierten Operationen vormerken?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'confirmAddToQueueMessage','default'=>'You are about to add [0] products to the queue. Do you really want to queue those products to be batch processed with the operations you defined?','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
Erstelle Queue für die Stapelverarbeitung<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'creatingQueue','default'=>'Creating queue for bulk changes','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Füge zum Queue hinzu...<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'startingAddToQueue','default'=>'Adding to queue...','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
    },
...
Führe Stapelverarbeitung durch<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'creatingBatchWindow','default'=>'Batch-changing products','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Starte die Stapelverarbeitung...<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'startingImport','default'=>'Starting BatchProcess ...','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
    },
    ...
    addToQueue: function(config, offset, queueId, startTime) {
        ...
        Ext.Ajax.request({
            type: "POST",
            url: '<?php echo '/goshop/backend/ArticleList/createQueue';?>',
            timeout: 4000000,
            params : {
                resource: 'product',
...
[0] / [1] verarbeitet. [2]:[3]:[4] Restdauer<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'processedItems','default'=>'[0] / [1] processed. [2]:[3]:[4] remaining','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
",
...
Queue erzeugt<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'createdQueueTitle','default'=>'Created queue','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Queue für [0] Produkte mit folgendem Filter erzeugt: [1]<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'createdQueueMessage','default'=>'Created queue for [0] items for this filter: [1]','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
');
    ...
    runBatchProcess: function(queueId, config, startTime) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/goshop/backend/ArticleList/batch';?>',
            timeout: 4000000,
            params : {
                resource: 'product',
                limit: 200,
...
Fertig<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'batchDoneTitle','default'=>'Done','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
[0] Produkte mit folgenden Regeln verarbeitet: [1]<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'batchDoneMessage','default'=>'Processed [0] items with following rules: [1]','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
\n',
...
Unbekannter Filter<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'unknownFilter','default'=>'Unknown filter','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
';
        } else {
