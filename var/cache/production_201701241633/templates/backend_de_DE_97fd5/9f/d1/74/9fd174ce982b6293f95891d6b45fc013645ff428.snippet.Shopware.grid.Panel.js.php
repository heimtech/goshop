<?php /* Smarty version Smarty-3.1.12, created on 2017-03-02 17:31:04
         compiled from "C:\wamp64\www\goshop\themes\Backend\ExtJs\backend\base\application\Shopware.grid.Panel.js" */ ?>
<?php /*%%SmartyHeaderCode:783958b848c8d15fd3-13985997%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9fd174ce982b6293f95891d6b45fc013645ff428' => 
    array (
      0 => 'C:\\wamp64\\www\\goshop\\themes\\Backend\\ExtJs\\backend\\base\\application\\Shopware.grid.Panel.js',
      1 => 1485272022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '783958b848c8d15fd3-13985997',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_58b848c92967d0_05906981',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b848c92967d0_05906981')) {function content_58b848c92967d0_05906981($_smarty_tpl) {?>
...
Ext.define('Shopware.grid.Panel', {
     ...
     * @type { String }
     */
    pageSizeLabel: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"grid_panel/page_size_label",'default'=>'Items per page','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_panel/page_size_label",'default'=>'Items per page','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Einträge pro Seite<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_panel/page_size_label",'default'=>'Items per page','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    addButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"grid_panel/add_button_text",'default'=>'Add item','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_panel/add_button_text",'default'=>'Add item','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Hinzufügen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_panel/add_button_text",'default'=>'Add item','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    deleteButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"grid_panel/delete_button_text",'default'=>'Delete all selected','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_panel/delete_button_text",'default'=>'Delete all selected','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Markierte Einträge löschen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_panel/delete_button_text",'default'=>'Delete all selected','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    searchFieldText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"grid_panel/search_field_text",'default'=>'Search ...','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_panel/search_field_text",'default'=>'Search ...','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Suche ...<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_panel/search_field_text",'default'=>'Search ...','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    pagingItemText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"grid_panel/paging_toolbar/item_text",'default'=>'items','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_panel/paging_toolbar/item_text",'default'=>'items','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Einträge<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"grid_panel/paging_toolbar/item_text",'default'=>'items','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
